...
const ndrProducts = [
    ...
    {name: '800G 光模块NDR', model: 'MMA4Z00-NS', desc: 'NVIDIA twin port transceiver, 800Gbps,2xNDR, OSFP, 2xMPO12 APC, 850nm MMF, up to 50m, finned', qty: 0},
    ...
    {name: '800G 光模块XDR', model: 'MMS8X00-NS800', desc: 'NVIDIA single port transceiver, 800Gbps,XDR, OSFP, MPO12 APC, 1310nm SMF, up to 500m, flat top', qty: 0},
